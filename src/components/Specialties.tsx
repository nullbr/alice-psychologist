  ...
  return (
    <section id="specialties" className="section-offset">
      <div className="max-w-3xl mx-auto px-6 py-10">
        <h2 className="mb-6 text-center">Minhas Especialidades</h2>
        ...
        <div className="relative bg-brown-600 shadow-xl md:mt-10 rounded-xl text-white p-6 pt-10 text-lg font-light tracking-wide">
